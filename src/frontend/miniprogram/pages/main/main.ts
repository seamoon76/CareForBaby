...
Page({
  ...
  OnTapGoToManageInfusions() {
    wx.navigateTo({
      url: '../manageInfusions/index/index',
    })
  },

  OnTapGoToInfusions() {
    wx.navigateTo({
      url: '../Infusions/choosePatient/choosePatient',
    })
  },
  OnTapGoToInspections() {
    wx.navigateTo({
      url: '../inspection/selectPatients/selectPatients',
    })
  }
})