// pages/admin/nurseDetaildInfoRevised/nurseDetaildInfoRevised.ts
...
Page({
  ...
  onLoad(option) {
    this.setData({
      db_ID: option.id_to_check,
    }, function() {
      // this is setData callback
    });
    this.data.admin_db_ID=wx.getStorageSync('g_admin_db_ID');
    this.data.admin_db_ID=wx.getStorageSync('g_admin_staff_ID');
